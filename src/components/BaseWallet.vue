<template>
  ...
  >
    <div class="flex row full-width items-center justify-center">
      <div>
        <BaseSelect
          :selecting="showWalletPicker"
          @toggle="showWalletPicker = !showWalletPicker"
          style="width: 100%"
        >
          <template #default>
            <div
            ...
            >
              <img
                ...
                style="height: 1.5rem; width: 1.5rem; border-radius: 0.3rem"
              />
            ...
            <q-dialog v-model="showWalletPicker">
              ...
              >
                <li
                  ...
                  class="flex row items-center no-wrap q-pl-xs"
                  style="gap: 0.5rem"
                >
                  <img
                    v-if="!loadingInvoice"
    ...
    <div v-if="!isInvoice" class="flex row justify-center" style="gap: 0.3rem">
      <q-btn
        v-for="(amount, index) in tipPresets"
        :key="index"
        :label="amount + ' sats'"
        size="sm"
        outline
        @click.stop="tipAmount = amount"
      />
    ...
    >
      ...
      <q-btn
        ...
        class="full-width"
        :label="
          hasWebLn && selectedWallet.prefix === 'lightning:'
            ? 'pay'
            : 'open wallet'
        "
        color="primary"
