...
worker.onmessage = (ev) => {
  let { id, success, error, data, stream, type, notice, eose } =
...
export function call(name, args) {
  ...
  worker.postMessage(
    JSON.parse(JSON.stringify({ id, name, args, call: true }))
  )
...
export async function streamMainProfilesFollows(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function streamMainMentions(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function streamMainIncomingMessages(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function streamMainOutgoingMessages(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
  return stream(
    'streamMainOutgoingMessages',
    [settings],
    callback,
    eoseCallback
  )
...
export async function streamPeerIncomingMessages(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
  return stream(
    'streamPeerIncomingMessages',
    [settings],
    callback,
    eoseCallback
  )
...
export async function streamPeerOutgoingMessages(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
  return stream(
    'streamPeerOutgoingMessages',
    [settings],
    callback,
    eoseCallback
  )
...
export async function dbStreamEvent(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function dbStreamFollows(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function dbStreamFollowers(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function dbStreamTagKind(
  settings = {},
  callback = () => {},
  eoseCallback = () => {}
) {
...
export async function dbMessages(
  userPubkey,
  peerPubkey,
  limit = 50,
...
export async function dbMentions(
  pubkey,
  limit = 40,
  until = Math.round(Date.now() / 1000)
) {
